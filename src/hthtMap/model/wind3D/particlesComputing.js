...
export default class ParticlesComputing {
  ...
  randomizeParticles(maxParticles, viewerParameters,data) {
  ...
  createParticlesTextures(context, userInput, viewerParameters,data) {
    ...
    const particlesArray = this.randomizeParticles(userInput.maxParticles, viewerParameters,data)
    ...
    this.primitives = {
      getWind: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [Util.loadText('./files/glsl/getWind.frag')]
        }),
      ...
      updateSpeed: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [Util.loadText( './files/glsl/updateSpeed.frag')]
        }),
      ...
      updatePosition: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [Util.loadText( './files/glsl/updatePosition.frag')]
        }),
      ...
      postProcessingPosition: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [Util.loadText( './files/glsl/postProcessingPosition.frag')]
        }),
      ...
      postProcessingSpeed: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [Util.loadText('./files/glsl/postProcessingSpeed.frag')]
        }),
