        ...
        this.primitives = {
            segments: new CustomPrimitive({
                ...
                vertexShaderSource: new Cesium.ShaderSource({
                    sources: [Util.loadText( './files/glsl/segmentDraw.vert')]
                }),
                fragmentShaderSource: new Cesium.ShaderSource({
                    sources: [Util.loadText( './files/glsl/segmentDraw.frag')]
                }),
            ...
            trails: new CustomPrimitive({
                ...
                vertexShaderSource: new Cesium.ShaderSource({
                    ...
                    sources: [Util.loadText( './files/glsl/fullscreen.vert')]
                }),
                fragmentShaderSource: new Cesium.ShaderSource({
                    defines: ['DISABLE_LOG_DEPTH_FRAGMENT_WRITE'],
                    sources: [Util.loadText( './files/glsl/trailDraw.frag')]
                }),
                rawRenderState: Util.createRawRenderState({
                    viewport: undefined,
                    depthTest: {
            ...
            screen: new CustomPrimitive({
                ...
                fragmentShaderSource: new Cesium.ShaderSource({
                    defines: ['DISABLE_LOG_DEPTH_FRAGMENT_WRITE'],
                    sources: [Util.loadText('./files/glsl/screenDraw.frag')]
                }),
                rawRenderState: Util.createRawRenderState({
                    viewport: undefined,
                    depthTest: {
